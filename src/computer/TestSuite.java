...
public class TestSuite extends BaseTest {
    ...
    private void selectByValueFromDropDown(By id, String s) {
    }
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws ElementClickInterceptedException, InterruptedException {
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"),"christina");
        sendTextToElement(By.name("BillingNewAddress.LastName"),"George");
        sendTextToElement(By.name("BillingNewAddress.Email"),"chris1@gmail.com");
        selectByValueFromDropDown(By.id("BillingNewAddress_CountryId"),"239");

        sendTextToElement(By.id("BillingNewAddress_City"),"NewYork");
        sendTextToElement(By.name("BillingNewAddress.Address1"),"2,Redwood Street");
        ...
        sendTextToElement(By.id("CardholderName"),"christina");
    ...
    private void clickOnElement(By xpath) {
    }

    private void sendTextToElement(By name, String s) {
    }

    private void assertVerifyText(By xpath, String thank_you) {
    }

    private void selectByVisibleTextFromDropDown(By product_attribute_1, String s) {
    }
